...
class TrController extends State<TrView> implements MvcController {
  ...
  List httpExerciseList = [
    {
      "label": "Login",
      "view": const HtLoginView(), // DONE
    },
    {
      "label": "Product List",
      "view": const HtProductListView(), // DONE
    },
    {
      "label": "Dashboard",
      "view": const HtDashboardView(), // DONE
    },
    {
      "label": "Image Galleries",
      "view": const HtImageGalleriesView(), // DONE
    },
    {
      "label": "Statistic Card",
      "view": const HtStatisticCardView(), // DONE
    },
    {
      "label": "Line Chart",
      "view": const HtLineChartView(), // DONE
    },
    {
      "label": "Pie Chart",
      "view": const HtPieChartView(), // DONE
    },
    {
      "label": "Todolist",
      "view": const HtTodoListView(), // DONE
    },
    {
      "label": "Product CRUD",
      "view": const HtProductCrudListView(), // DONE
    },
    {
      "label": "Map Marker",
      "view": const HtMapMarkerView(), // DONE
    },
  ];
  ...
  List lsExerciseList = [
    {
      ...
      "view": const LsFirstTimeSetupView(), // DONE
    },
    {
      "label": "Login Form with History",
      "view": const LsLoginFormWithHistoryView(), // DONE
    },
    {
      "label": "Login and Save Token",
      "view": const LsLoginAndSaveTokenView(), // DONE
    },
    {
      "label": "Create PIN",
      "view": const LsCreatePinView(), // DONE
    },
    {
      "label": "Login by PIN",
      "view": const LsLoginByPinView(), // DONE
    },
    {
      "label": "Customer CRUD",
      "view": const LsCustomerCrudView(), // DONE
    },
    {
      "label": "Product CRUD",
      "view": const LsProductCrudView(), // DONE
    },
    {
      "label": "POS",
      "view": const LsPosView(), // DONE
    },
    {
      "label": "POS with Table Selection",
      "view": const LsPosWithTableSelectionView(), // DONE
    },
    {
      "label": "Favorite",
      "view": const LsFavoriteView(), // DONE
    },
    {
      "label": "User Setting",
      "view": const LsUserSettingView(), // DONE
    },
  ];
